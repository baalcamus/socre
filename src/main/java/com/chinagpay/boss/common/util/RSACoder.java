...
//
			...
			System.out.println("公钥:"+pbkey.length());
			System.out.println("私钥:"+prkey.length());
//			
...
//			
//			System.out.println("解密�?:"+new String(decodedData1));
//			
//			
...
//			System.out.println("解密�?:"+new String(decodedData2));
//					}catch(InvalidKeySpecException e){
//			System.out.println("密钥不合�?");
//			e.printStackTrace();
		} catch (Exception e) {
