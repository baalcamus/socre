 ...
 *
 */
 public static synchronized String formatDate(String strDate){
 	String test1;
	try {
...
//   return gc.getTime();
  ...
  Date date )
 {
  ...
  GregorianCalendar gc = ( GregorianCalendar ) Calendar.getInstance();
  gc.setTime( date );
  gc.setTime( DateUtil2.getNextMonth( gc.getTime() ) );
  gc.setTime( DateUtil2.getLastDayOfMonth( gc.getTime() ) );
  return gc.getTime();
 }
  ...
  Date date )
 {
  ...
  GregorianCalendar gc = ( GregorianCalendar ) Calendar.getInstance();
  gc.setTime( date );
  gc.setTime( DateUtil2.getNextWeek( gc.getTime() ) );
  gc.setTime( DateUtil2.getLastDayOfWeek( gc.getTime() ) );
  return gc.getTime();
 }
  ...
  Date date )
 {
  ...
  gc.setTime( date );
  gc.setTime( DateUtil2.getNextMonth( gc.getTime() ) );
  gc.setTime( DateUtil2.getFirstDayOfMonth( gc.getTime() ) );
  return gc.getTime();
 }
  ...
  Date date )
 {
  ...
  gc.setTime( date );
  gc.setTime( DateUtil2.getNextWeek( gc.getTime() ) );
  gc.setTime( DateUtil2.getFirstDayOfWeek( gc.getTime() ) );
  return gc.getTime();
 }
...
//		ca.set(Calendar.DATE,1);//设为当前月的1号   
	...
	public static String getYesterdayCreateTime(){
		 SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd"); 
		Calendar   cal   =   Calendar.getInstance();
		  cal.add(Calendar.DATE,   -1);
		return  format.format(cal.getTime());
	}
	public static synchronized String formatDate1(String strDate,String type){
		String test1;
		try {
	...
	public static synchronized String formatDate5(String strDate){
		String test1;
		try {
			SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
			Date test = formatter.parse(strDate);
	...
	public static synchronized String formatDate51(String strDate){
		String test1;
		try {
	...
	public static synchronized String formatDate7(String strDate){
		String test1;
		try {
			SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
			Date test = formatter.parse(strDate);
	...
	public static synchronized String formatDate2(String strDate){
		String test1;
		try {
			SimpleDateFormat formatter = new SimpleDateFormat("yyyyMMddHHmmss");
			Date test = formatter.parse(strDate);
	...
	public static synchronized String formatDate3(String strDate){
		String test1;
		try {
			SimpleDateFormat formatter = new SimpleDateFormat("yyyyMMddHHmmss");
			Date test = formatter.parse(strDate);
	...
	public static synchronized String formatDate4(Date test){
			SimpleDateFormat formatter1 = new SimpleDateFormat("yyyyMMddHHmmss");
			String test1 = formatter1.format(test);
			return test1;
	 }
	/**
	 * 获取昨天日期
	 ...
	 * @return
	 */
	public static String getYesterdayDateOfStyle(String style){
	 ...
	 * @return
	 */
	public static String getYesterdayDateOfStyle1(String style){
		if (style.equals("") || style==null) {
			return null;
		}
			Calendar cal=Calendar.getInstance();
	...
	public static int getTime(String time,String a) throws ParseException{
		SimpleDateFormat format = new SimpleDateFormat("yyyyMMdd");
		Date d=format.parse(time);
		Date a1=format.parse(a);
		//当前时间处理
		Calendar cal = Calendar.getInstance();
		cal.setTime(a1);
		...
		return Integer.valueOf(String.valueOf(-dayDiff));
	}
	
	public static String isBeforCurrentTime1(String dateTime ,String pattern ){	
		try {
			Calendar beforTime =Calendar.getInstance();
			DateFormat df=new SimpleDateFormat(pattern);
			beforTime.setTime(df.parse(dateTime));
			beforTime.add(Calendar.DATE,-1);
		   Date date=beforTime.getTime();
		  return getDateFormat(date,pattern);
		} catch (ParseException e) {
			e.printStackTrace();
			return "";
...
//		System.out.println(formatDate2("20140118000000"));
		System.out.println(formatDate5("2015-10-09 00:00:00"));
//		String x = 	getTomorrowDate(getDate("MMdd"), 1,"MMdd");
//		System.out.println(formatDate("2015-04-08 12:07:48"));
	}
	...
	public static synchronized String formatDate6(String strDate){
		String test1;
		try {
			SimpleDateFormat formatter = new SimpleDateFormat("yyyyMMddHHmmss");
			Date test = formatter.parse(strDate);
