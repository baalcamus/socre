				...
				<div class="page-content">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form action="<%=request.getContextPath()%>/cbMerchant/queryMerchant" method="post" id="queryForm" name="queryForm"
							...
							<div class="table-responsive border0">
								<table class="table table-hover">
									...
									<c:forEach items="${page.list}" var="_l_merchantInfo_">
										<tr>
											<td><a href="<%=request.getContextPath() %>/cbzpay/ecsauthmgr?merchantNo=${_l_merchantInfo_.merchantNo}">跨境权限管理</a></td>
