        ...
        <div id="page-wrapper">
            ...
            <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                <ol class="breadcrumb page-breadcrumb">
                    ...
                    <li>哗啦啦通道路由切换&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;
                    </li>
                </ol>
            ...
            <div class="page-content">
                ...
                <div class="panel panel-default">
                    ...
                    <div>
                        <form id="queryForm"
                              action="<%=request.getContextPath()%>/micropay/toRouteList"
                                    ...
                                    <c:forEach items="${routes}" var="route">
                                        <tr>
                                            <td><c:if test="${route.status=='VALID'}"></c:if>
                                                <c:if test="${route.status=='INVALID'}"><a style="color: blue" href="javascript:updateRoute('${route.fixedMctNo}','${route.channelNo}','${route.payMethodMode}','${route.payProductMode}')">使用</a></c:if></td>
                                            <td>${route.fixedMctNo}</td>
...
<script type="text/javascript">
    function updateRoute(merchantNo,channelNo,payMethod,payProduct) {
        $.post("<%=request.getContextPath()%>/micropay/updateRoute",
                {
                ...
                function(msg){
                    ...
                    location.replace("<%=request.getContextPath()%>/micropay/toRouteList");
                }
        );
    }
</script>
