...
<script type="text/javascript">	
    function changeUser() {
    	...
    	var regLoginPwd =/^[\@A-Za-z0-9\_\*]{6,20}$/;
   		...
   		$.post( "<%=request.getContextPath()%>/systemManage/changeUser.do",{
			loginName:loginName,
			realName:realName,
			loginPwd:loginPwd,
			consoleDepId:consoleDepId,
			id:userid,
		...
		function (data){
			...
			if(data=="ok"){
				alert("修改成功");
				window.location.href='<%=request.getContextPath()%>/systemManage/toUserSearch.do';
			}else{
				alert("用户状态异常！请联系管理员！");
				return ;
			}
									...
									<form method="post" enctype="multipart/form-data" id="form"
											...
											<div
												...
												<table width="100%" class="product_detail_list">
													<tr>
														...
														<td width="200"><input type="text" maxlength="32" readonly
															name="loginName" id="loginName" value="${loginName }"
															class="form-control"></td>
														<td><span id="loginNameSpan" style="display: none"
															class="colorhui">用户账号不能为空，由英文和数字组成，长度为3-16个字符</span> <span
															id="loginNameSpan2" style="display: none"
															class="colorhui">用户账号已存在</span></td>
													</tr>
												</table>
											</div>
										</div>
											...
											<div
												...
												<table width="100%" class="product_detail_list">
													<tr>
														...
														<td width="200"><input type="text" maxlength="64"
															name="realName" id="realName" value="${realName }"
															class="form-control"></td>
														<td><span id="realNameSpan" style="display: none"
															class="colorhui">用户昵称用于页面显示的用户名，长度为3-32个字符</span></td>
													</tr>
												</table>
											</div>
										</div>
												...
												<table width="100%" class="product_detail_list">
													<tr>
														...
														<td width="200"><input type="password" maxlength="40"
															...
															class="form-control"></td>
														<td><span id="loginPwdSpan" style="display: none"
															class="colorhui">用户密码不能为空，密码为6-20个字符包括（英文、数字、下划线、*）</span></td>
													</tr>
												</table>
											</div>
										</div>
											...
											<div
												...
												<table width="100%" class="product_detail_list">
													<tr>
														...
														<td width="200"><input type="password" maxlength="40"
															name="loginPwdAgain" id="loginPwdAgain" value="******"
															class="form-control"></td>
														<td><span id="loginPwdAgainSpan"
															style="display: none" class="colorhui">重复密码需与用户密码相同，为必填项</span></td>
													</tr>
												</table>
											</div>
										</div>
												...
												<table width="100%" class="product_detail_list">
													<tr>
														...
														<select class="form-control"
															tabindex="10" name="consoleDepId" id="consoleDepId">
															
																<c:forEach items="${consoleDepList}" var="consoleDep">
                                                                 
                                                                   <c:choose>
																		<c:when test="${consoleDepId eq consoleDep.id}">
																			<option value="${consoleDep.id}" selected="selected">${consoleDep.department}</option>
																		</c:when>
																		<c:otherwise>
										...
										<div class="row">
											<div
												class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-12 col-xs-12">
												<table width="100%"
													class="product_detail_list bghui fa-border">
													<tr>

														<td width="160" colspan="2">
														<td>
															<!------- 	权限开始		List<Rule> ruleList		--> <script
	                 	...
	                 	function checkStatus(no,chkBox){
	                 		...
	                 		    }
													...
													<tr>
														...
														<td colspan="2"><a onclick="checkAll();"
															class="btn btn-default"> 全选 </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
															onclick="uncheckAll();" class="btn btn-default">全不选 </a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
													</tr>
												</table>
											</div>
										</div>
							...
							<div class="save-box-grey clearfix">
								<center>
									<a href="javascript:changeUser()" class="btn btn-danger"><i
