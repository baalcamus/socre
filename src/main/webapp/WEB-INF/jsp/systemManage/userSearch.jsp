               ...
               <input type="hidden" name="pageSize" value="${page.pageSize }"/>
                      ...
                      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                         <table width="100%" class="product_detail_list">
                            ...
                            <td>
                              <input type="text" maxlength="32" id="loginName" name="loginName" value="${user.loginName}" class="form-control" >
                           </td>
                           </tr>
                           </table>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                         <table width="100%" class="product_detail_list">
                            ...
                            <td>
                              <input type="text"  maxlength="64" id="realName" name="realName" value="${user.realName}" class="form-control" >
                           </td>
                           </tr>
                           </table>
                        </div>
