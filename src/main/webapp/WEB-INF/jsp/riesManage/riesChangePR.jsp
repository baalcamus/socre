...
<script type="text/javascript">
	...
	function editPR(){
		console.log("进入提交方法");
		$.post("<%=request.getContextPath()%>/riesManage/riesEditPReport", $('#subform').serialize() ,
		function (data){
			if(data=="success"){
				alert("修改成功");
			window.location.href="<%=request.getContextPath()%>/riesManage/riesEditPQList";
			}else{
				alert("修改失败!");
			...
			<div class="page-content">
				<div class="panel panel-default  withoutbottom clearfix">
					<header class="panel-heading clearfix">
						<h2 class="panel-title">个人信息修改</h2>
					</header>

					<div class="panel-body clearfix">
						<form class="form-horizontal"  method="post"  role="form" enctype="multipart/form-data"
						 id="subform" action="">
						     <input  hidden='hidden'   value="${personChangeQueryDTO.id}" id="Id" name="Id"></input>
						     <input   hidden='hidden'  value="${personChangeQueryDTO.orgId}" id="OrgId" name="OrgId"></input>
						     <input    hidden='hidden' value="${personChangeQueryDTO.repDate}" id="RepDate" name="RepDate"></input>
						     <input  hidden='hidden'  value="${personChangeQueryDTO.repType}" id="RepType" name="RepType"></input>
						     <input  hidden='hidden'  value="${personChangeQueryDTO.repPerson}" id="RepPerson" name="RepPerson"></input>
							<div class="panel-inner">
								...
								<div class="panel-inner-body">
												...
												<tr>
													<td width="120" class="text-right">风险类型<span>*</span></td>
														<td><select name="RiskType" id="RiskType" class="form-control">
																<option
																	<c:if test="${personChangeQueryDTO.riskType==''}">selected="selected"</c:if>
																	value="">请选择</option>
																<c:forEach var="_riskType"
																	items="${fns:getEnumValues(\"com.chinagpay.ries.enumtype.RiseEnum\",\"RiskStatusEnum\")}">
																	<option
																		<c:if test="${personChangeQueryDTO.riskType==_riskType.code }"> selected="selected"</c:if>
											...
											<table width="100%" class="product_detail_list">
												<tr>
													...
													<td><input type="text" class="form-control"
														...
														value="${personChangeQueryDTO.mobileNo}"></td>
												</tr>
											</table>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
											<table width="100%" class="product_detail_list">
												<tr>
													...
													<td><input type="text" class="form-control"
														id="Mac" name="Mac"
														value="${personChangeQueryDTO.mac}"></td>
												</tr>
											</table>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
											<table width="100%" class="product_detail_list">
												<tr>
													...
													<td><input type="text" class="form-control"
														id="Imei" name="Imei"
														value="${personChangeQueryDTO.imei}"></td>
												</tr>
											</table>
										</div>
									</div>
											...
											<table width="100%" class="product_detail_list">
												<tr>
													...
													<td><input type="text" class="form-control"
														...
														value="${personChangeQueryDTO.bankNo}"></td>
												</tr>
											</table>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
											<table width="100%" class="product_detail_list">
												<tr>
													...
													<td><input type="text" class="form-control"
														...
														value="${personChangeQueryDTO.openBank}"></td>
												</tr>
											</table>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
											<table width="100%" class="product_detail_list">
												<tr>
													...
													<td><input type="text" class="form-control"
														...
														value="${personChangeQueryDTO.cusName}"></td>
												</tr>
											</table>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
											<table width="100%" class="product_detail_list">
												<tr>
													...
													<td><input type="text" class="form-control"
														...
														value="${personChangeQueryDTO.docCode}"></td>
												</tr>
											</table>
										</div>
									</div>
										...
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
											<table width="100%" class="product_detail_list">
												<tr>
													...
													<td><input type="text" class="form-control"
														id="Ip" name="Ip"
														value="${personChangeQueryDTO.ip}"></td>
												</tr>
											</table>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
											<table width="100%" class="product_detail_list">
												<tr>
													...
													<td><input type="text" class="form-control"
														...
														value="${personChangeQueryDTO.address}"></td>
												</tr>
											</table>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
											<table width="100%" class="product_detail_list">
												<tr>
													...
													<td><input type="text" class="form-control"
														...
														value="${personChangeQueryDTO.telephone}"></td>
												</tr>
											</table>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
											<table width="100%" class="product_detail_list">
												<tr>
													...
													<td><input type="text" class="form-control"
														...
														value="${personChangeQueryDTO.recBankNo}"></td>
												</tr>
											</table>
										</div>
									</div>
									...
									<div class="row" id="agent1">
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
											<table width="100%" class="product_detail_list">
												<tr>
													...
													<td><input type="text" class="form-control"
														id="Email" name="Email"
														value="${personChangeQueryDTO.email}"></td>
												</tr>
											</table>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
										...
										name="ValidDate" value="${personChangeQueryDTO.occurtimeb}"
										...
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
											<table width="100%" class="product_detail_list">
												<tr>
													...
													<option
																	<c:if test="${personChangeQueryDTO.level==''}">selected="selected"</c:if>
																	value="">请选择</option>
																<c:forEach var="_level"
																	items="${fns:getEnumValues(\"com.chinagpay.ries.enumtype.RiseEnum\",\"LevelEnum\")}">
																	<option
																		<c:if test="${personChangeQueryDTO.level==_level.code }"> selected="selected"</c:if>
								...
								<td><input class="form-control" id="Occurtimeb"
										name="Occurtimeb" value="${personChangeQueryDTO.occurtimeb}"
										onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})" /></td>
												</tr>
											</table>
										</div>
									...
									<div class="row" id="agent1">
										...
										name="Occurtimee" value="${personChangeQueryDTO.occurtimee}"
										onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})" />		</td>
												</tr>
											</table>
										</div>
									...
									<td>	
													   <select name="Occurchan" id="Occurchan" class="form-control">
																<option
																	<c:if test="${personChangeQueryDTO.occurchan==''}">selected="selected"</c:if>
																	value="">请选择</option>
																<c:forEach var="_occurchan"
																	items="${fns:getEnumValues(\"com.chinagpay.ries.enumtype.RiseEnum\",\"OccurrenceChannelEnum\")}">
																	<option
																		<c:if test="${personChangeQueryDTO.occurchan==_occurchan.code }"> selected="selected"</c:if>
											...
											<table width="100%" class="product_detail_list">
												<tr>
													...
													<td><input type="text" readonly="readonly" class="form-control"
														...
														value="1">
<%-- 														value="${personChangeQueryDTO.occurarea}"> --%>
										...
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
											<table width="100%" class="product_detail_list">
												<tr>
													...
													<td><input type="text" class="form-control"
														id="Note" name="Note"
														value="${personChangeQueryDTO.note}"></td>
												</tr>
											</table>
										</div>
									</div>
											...
											<table width="100%" class="product_detail_list">
												<tr>
													...
													<td><input type="text" class="form-control"
														...
														value="${personChangeQueryDTO.recOpenBank}"></td>
												</tr>
											</table>
										</div>
											<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
