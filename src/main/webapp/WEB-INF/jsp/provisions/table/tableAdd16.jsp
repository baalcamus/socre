...
<script type="text/javascript">	
	...
	function changename(){
		...
		$("#acctStyle option").each(function(){
		   if($(this).text() === acctTypeName){
										...
										<table>
											...
											<tr>
												...
												<td width="200">	
													...
													<c:forEach items="${accounts}" var="account">
														<input type="hidden" id="${account.acctNo}" value="${account.childBankName},${account.acctName},${account.provBranchName},${account.acctType}"/>
													</c:forEach>
												</td>
												<td width="150"></td>
											...
											<tr>
												...
												<td width="200">
													<select class="form-control" id="acctType" name="acctType"  style="color:#d9534f">
														<option value="">--请选择--</option>
														<option value="0" selected="selected">备付金专用存款账户</option>
														<option value="1">备付金非活期存款账户</option>
													</select>
												</td>
												<td width="150"></td>
												...
												<td width="200">
													<select class="form-control" id="acctStyle" name="acctStyle"  style="color:#d9534f" disabled="disabled">
														<option value="">--请选择--</option>
														<option value="A">存管账户</option>
														<option value="B">收付账户</option>
														<option value="C">汇缴账户</option>
														<option value="D">其他账户</option>
													</select>
												</td>
											</tr>
											<tr height="15"></tr>
											<tr>
												...
												<td width="200"><input type="text" id="balance" name="balance" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
											</tr>
											<tr height="10"></tr>
										</table>
