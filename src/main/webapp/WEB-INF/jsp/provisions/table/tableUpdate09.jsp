									...
									<form method="post" enctype="multipart/form-data" class="form-horizontal">
										...
										<table>
											...
											<tr>
												...
												<td width="200">	
													<select class="form-control" id="acctNo" name="acctNo" onchange="changename();" style="color:#d9534f" disabled="disabled">
											...
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">已增加客户资金,未增加备付金账户余额J01<span>*</span></td>
												<td width="200"><input type="text" id="J01" name="J01" value="${table.j01}" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">已减少客户资金,未减少备付金账户余额J02<span>*</span></td>
												<td width="200"><input type="text" id="J02" name="J02" value="${table.j02}" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">已增加备付金,未增加客户资金账户余额J03<span>*</span></td>
												<td width="200"><input type="text" id="J03" name="J03" value="${table.j03}" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">已减少备付金,未减少客户资金账户余额J04<span>*</span></td>
												<td width="200"><input type="text" id="J04" name="J04" value="${table.j04}" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="10"></tr>
										</table>
										<div class="row">
