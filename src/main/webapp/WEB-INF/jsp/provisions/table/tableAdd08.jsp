									...
									<form method="post" enctype="multipart/form-data" class="form-horizontal">
										...
										<table>
											...
											<tr>
												...
												<td width="200"><input type="text" id="I01" name="I01" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">本期以自有资金先行赎回预付卡的金额I02<span>*</span></td>
												<td width="200"><input type="text" id="I02" name="I02" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">本期向备付金存管银行申请结转的金额I03<span>*</span></td>
												<td width="200"><input type="text" id="I03" name="I03" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">期末以自有资金先行赎回预付卡的余额I04<span>*</span></td>
												<td width="200"><input type="text" id="I04" name="I04" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="10"></tr>
										</table>
										<div class="row">
