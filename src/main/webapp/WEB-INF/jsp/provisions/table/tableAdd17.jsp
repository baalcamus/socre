									...
									<form method="post" enctype="multipart/form-data" class="form-horizontal">
										...
										<table>
											...
											<tr>
												...
												<td width="200"><input type="text" id="P01" name="P01" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">余额P02<span>*</span></td>
												<td width="200"><input type="text" id="P02" name="P02" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">开户个数P03<span>*</span></td>
												<td width="200"><input type="text" id="P03" name="P03" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">余额P04<span>*</span></td>
												<td width="200"><input type="text" id="P04" name="P04" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">开户个数P05<span>*</span></td>
												<td width="200"><input type="text" id="P05" name="P05" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">余额P06<span>*</span></td>
												<td width="200"><input type="text" id="P06" name="P06" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">开户个数P07<span>*</span></td>
												<td width="200"><input type="text" id="P07" name="P07" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">余额P08<span>*</span></td>
												<td width="200"><input type="text" id="P08" name="P08" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="10"></tr>
										</table>
										<div class="row">
