									...
									<form method="post" enctype="multipart/form-data" class="form-horizontal">
										...
										<table>
											...
											<tr>
												...
												<td width="200"><input type="text" id="BB04" name="BB04" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">前期系统反映，本期出金BB05<span>*</span></td>
												<td width="200"><input type="text" id="BB05" name="BB05" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">本期扣款的金额BB06<span>*</span></td>
												<td width="200"><input type="text" id="BB06" name="BB06" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">借记客户资金账户金额BB07<span>*</span></td>
												<td width="200"><input type="text" id="BB07" name="BB07" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">手续费收入等（支出）BB08<span>*</span></td>
												<td width="200"><input type="text" id="BB08" name="BB08" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">银行返回款项BB09<span>*</span></td>
												<td width="200"><input type="text" id="BB09" name="BB09" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="10"></tr>
										</table>
										<div class="row">
