								...
								<div class="panel-body">
									<form method="post" enctype="multipart/form-data" class="form-horizontal">
										...
										<table>
											...
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">账户类型<span>*</span></td>
												<td width="200">
													<select class="form-control" id="acctType" name="acctType"  style="color:#d9534f">
														<option <c:if test="${table.acctType=='' }">selected="selected"</c:if> value="">--请选择--</option>
														<option <c:if test="${table.acctType=='0' }">selected="selected"</c:if> value="0">备付金专用存款账户</option>
														<option <c:if test="${table.acctType=='1' }">selected="selected"</c:if> value="1">备付金非活期存款账户</option>
													</select>
												</td>
												<td width="150"></td>
												<td width="250" class="text-right">账户性质<span>*</span></td>
												<td width="200">
													<select class="form-control" id="acctStyle" name="acctStyle"  style="color:#d9534f" disabled="disabled">
														<option <c:if test="${table.acctStyle=='' }">selected="selected"</c:if> value="">--请选择--</option>
														<option <c:if test="${table.acctStyle=='A' }">selected="selected"</c:if> value="A">存管账户</option>
														<option <c:if test="${table.acctStyle=='B' }">selected="selected"</c:if> value="B">收付账户</option>
														<option <c:if test="${table.acctStyle=='C' }">selected="selected"</c:if> value="C">汇缴账户</option>
														<option <c:if test="${table.acctStyle=='D' }">selected="selected"</c:if> value="D">其他账户</option>
													</select>
												</td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">余额<span>*</span></td>
												<td width="200"><input type="text" id="balance" name="balance" value="${table.balance}" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
											</tr>
											<tr height="10"></tr>
										</table>
