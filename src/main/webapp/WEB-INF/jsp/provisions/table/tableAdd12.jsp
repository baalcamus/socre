									...
									<form method="post" enctype="multipart/form-data" class="form-horizontal">
										...
										<table>
											...
											<tr>
												...
												<td width="200"><input type="text" id="M01" name="M01" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">累计申请存放的自有资金余额M02<span>*</span></td>
												<td width="200"><input type="text" id="M02" name="M02" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">累计申请存放的自有资金余额M03<span>*</span></td>
												<td width="200"><input type="text" id="M03" name="M03" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">未结转的支付业务净收入余额M04<span>*</span></td>
												<td width="200"><input type="text" id="M04" name="M04" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">现金形式持有的客户备付金余额M05<span>*</span></td>
												<td width="200"><input type="text" id="M05" name="M05" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">自有资金先行偿付的预付卡赎回金额M06<span>*</span></td>
												<td width="200"><input type="text" id="M06" name="M06" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">已增加客户资金未增加备付金M07<span>*</span></td>
												<td width="200"><input type="text" id="M07" name="M07" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">已减少客户资金未减少备付金M08<span>*</span></td>
												<td width="200"><input type="text" id="M08" name="M08" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">已增加备付金未增加客户资金M09<span>*</span></td>
												<td width="200"><input type="text" id="M09" name="M09" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">已减少备付金未减少客户资金M10<span>*</span></td>
												<td width="200"><input type="text" id="M10" name="M10" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">其他调整项目M11<span>*</span></td>
												<td width="200"><input type="text" id="M11" name="M11" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">支付机构客户资金账户余额试算值M12<span>*</span></td>
												<td width="200"><input type="text" id="M12" name="M12" value="" class="form-control" style="color:#d9534f" onblur="getM14();"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">支付机构客户资金账户余额实际值M13<span>*</span></td>
												<td width="200"><input type="text" id="M13" name="M13" value="" class="form-control" style="color:#d9534f" onblur="getM14();"></td>
												<td width="150"></td>
												<td width="250" class="text-right">实际值-试算值M14<span>*</span></td>
												<td width="200"><input type="text" id="M14" name="M14" value="" class="form-control" style="color:#d9534f" disabled="disabled"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">预付卡押金业务调整金额Z02<span>*</span></td>
												<td width="200"><input type="text" id="Z02" name="Z02" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
