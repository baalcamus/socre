									...
									<form method="post" enctype="multipart/form-data" class="form-horizontal">
										...
										<table>
											...
											<tr>
												...
												<td width="200"><input type="text" id="E01" name="E01" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">本期入金业务贷记客户资金账户金额E02<span>*</span></td>
												<td width="200"><input type="text" id="E02" name="E02" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">本期出金业务借记客户资金账户金额E03<span>*</span></td>
												<td width="200"><input type="text" id="E03" name="E03" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">客户资金账户借方发生额E04<span>*</span></td>
												<td width="200"><input type="text" id="E04" name="E04" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">客户资金账户贷方发生额E05<span>*</span></td>
												<td width="200"><input type="text" id="E05" name="E05" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">客户资金账户期末余额E06<span>*</span></td>
												<td width="200"><input type="text" id="E06" name="E06" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="10"></tr>
										</table>
										<div class="row">
