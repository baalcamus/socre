									...
									<form method="post" enctype="multipart/form-data" class="form-horizontal">
										...
										<table>
											...
											<tr>
												...
												<td width="200"><input type="text" id="N01" name="N01" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">转账方式收到N02<span>*</span></td>
												<td width="200"><input type="text" id="N02" name="N02" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">现金形式缴存N03<span>*</span></td>
												<td width="200"><input type="text" id="N03" name="N03" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">转账方式直接付出N04<span>*</span></td>
												<td width="200"><input type="text" id="N04" name="N04" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">现金形式先行赎回业务中申请结转金额N05<span>*</span></td>
												<td width="200"><input type="text" id="N05" name="N05" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">期末备付金账户中押金余额N06<span>*</span></td>
												<td width="200"><input type="text" id="N06" name="N06" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="10"></tr>
										</table>
										<div class="row">
