									...
									<form method="post" enctype="multipart/form-data" class="form-horizontal">
										...
										<table>
											...
											<tr>
												...
												<td width="200"><input type="text" id="B01" name="B01" value="${table.b01}" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">本期业务应出金金额B02<span>*</span></td>
												<td width="200"><input type="text" id="B02" name="B02" value="${table.b02}" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">本期手续费等收入（支出）B03<span>*</span></td>
												<td width="200"><input type="text" id="B03" name="B03" value="${table.b03}" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">本期系统反映，本期出金B04<span>*</span></td>
												<td width="200"><input type="text" id="B04" name="B04" value="${table.b04}" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">前期系统反映，本期出金B05<span>*</span></td>
												<td width="200"><input type="text" id="B05" name="B05" value="${table.b05}" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">本期扣款的金额B06<span>*</span></td>
												<td width="200"><input type="text" id="B06" name="B06" value="${table.b06}" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">借记客户资金账户金额B07<span>*</span></td>
												<td width="200"><input type="text" id="B07" name="B07" value="${table.b07}" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">手续费收入等（支出）B08<span>*</span></td>
												<td width="200"><input type="text" id="B08" name="B08" value="${table.b08}" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">银行返回款项B09<span>*</span></td>
												<td width="200"><input type="text" id="B09" name="B09" value="${table.b09}" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
											</tr>
											<tr height="10"></tr>
										</table>
