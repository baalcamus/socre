								...
								<div class="panel-body">
									<form method="post" enctype="multipart/form-data" class="form-horizontal">
										...
										<table>
											...
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">期初接受的现金形式客户备付金余额H01<span>*</span></td>
												<td width="200"><input type="text" id="H01" name="H01" value="${table.h01}" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">本期接受现金形式的客户备付金金额H02<span>*</span></td>
												<td width="200"><input type="text" id="H02" name="H02" value="${table.h02}" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">本期向备付金银行缴存的现金备付金H03<span>*</span></td>
												<td width="200"><input type="text" id="H03" name="H03" value="${table.h03}" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">期末现金形式的客户备付金余额H04<span>*</span></td>
												<td width="200"><input type="text" id="H04" name="H04" value="${table.h04}" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="10"></tr>
										</table>
										<div class="row">
