								...
								<div class="panel-body">
									<form method="post" enctype="multipart/form-data" class="form-horizontal">
										...
										<table>
											...
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">账户实际出金C01<span>*</span></td>
												<td width="200"><input type="text" id="C01" name="C01" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">账户信息C02<span>*</span></td>
												<td width="200"><input type="text" id="C02" name="C02" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">合计C03<span>*</span></td>
												<td width="200"><input type="text" id="C03" name="C03" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
											</tr>
											<tr height="10"></tr>
										</table>
