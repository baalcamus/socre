									...
									<form method="post" enctype="multipart/form-data" class="form-horizontal">
										...
										<table>
											...
											<tr>
												...
												<td width="200"><input type="text" id="AA01" name="AA01" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">手续费收入（支出）AA02<span>*</span></td>
												<td width="200"><input type="text" id="AA02" name="AA02" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">押金其他AA03<span>*</span></td>
												<td width="200"><input type="text" id="AA03" name="AA03" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
											...
											<tr>
												...
												<td width="200"><input type="text" id="AA04" name="AA04" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">手续费收入（支出）AA05<span>*</span></td>
												<td width="200"><input type="text" id="AA05" name="AA05" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">押金其他AA06<span>*</span></td>
												<td width="200"><input type="text" id="AA06" name="AA06" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">其他OR2<span>*</span></td>
												<td width="200"><input type="text" id="OR2" name="OR2" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">本期业务系统中已贷记客户资金账户金额AA07<span>*</span></td>
												<td width="200"><input type="text" id="AA07" name="AA07" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">本期手续费收入(支出)AA08<span>*</span></td>
												<td width="200"><input type="text" id="AA08" name="AA08" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">押金其他AA09<span>*</span></td>
												<td width="200"><input type="text" id="AA09" name="AA09" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">其他OR3<span>*</span></td>
												<td width="200"><input type="text" id="OR3" name="OR3" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">业务系统中贷记客户资金账户金额AA11<span>*</span></td>
												<td width="200"><input type="text" id="AA11" name="AA11" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">手续费收入（支出）AA12<span>*</span></td>
												<td width="200"><input type="text" id="AA12" name="AA12" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">押金其他AA13<span>*</span></td>
												<td width="200"><input type="text" id="AA13" name="AA13" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">其他OR4<span>*</span></td>
												<td width="200"><input type="text" id="OR4" name="OR4" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="10"></tr>
										</table>
										<div class="row">
