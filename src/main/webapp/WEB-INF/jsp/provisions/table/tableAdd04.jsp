									...
									<form method="post" enctype="multipart/form-data" class="form-horizontal">
										...
										<table>
											...
											<tr>
												...
												<td width="200"><input type="text" id="D01" name="D01" value="" class="form-control" style="color:#d9534f" disabled="disabled"></td>
												<td width="150"></td>
												<td width="250" class="text-right">客户资金账户贷方发生额D02<span>*</span></td>
												<td width="200"><input type="text" id="D02" name="D02" value="" class="form-control" style="color:#d9534f" onblur="getNum();"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">手续费收入D03<span>*</span></td>
												<td width="200"><input type="text" id="D03" name="D03" value="" class="form-control" style="color:#d9534f" onblur="getNum();"></td>
												<td width="150"></td>
												<td width="250" class="text-right">其他D04<span>*</span></td>
												<td width="200"><input type="text" id="D04" name="D04" value="" class="form-control" style="color:#d9534f" onblur="getNum();"></td>
											</tr>
											<tr height="10"></tr>
										</table>
										<div class="row">
