									...
									<form method="post" enctype="multipart/form-data" class="form-horizontal">
										...
										<table>
											...
											<tr>
												...
												<td width="200"><input type="text" id="L01" name="L01" value="" class="form-control" style="color:#d9534f" onblur="getL03();"></td>
												<td width="150"></td>
												<td width="250" class="text-right">期末客户资金账户余额L02<span>*</span></td>
												<td width="200"><input type="text" id="L02" name="L02" value="" class="form-control" style="color:#d9534f" onblur="getL03();"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">客户资金账户余额净增加（减少）L03<span>*</span></td>
												<td width="200"><input type="text" id="L03" name="L03" value="" class="form-control" style="color:#d9534f" disabled="disabled"></td>
												<td width="150"></td>
												<td width="250" class="text-right">接受现金形式的客户备付金金额（减）L04<span>*</span></td>
												<td width="200"><input type="text" id="L04" name="L04" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">向备付金银行缴存现金备付金（加）L05<span>*</span></td>
												<td width="200"><input type="text" id="L05" name="L05" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">自有资金先行赎回预付卡的金额（加）L06<span>*</span></td>
												<td width="200"><input type="text" id="L06" name="L06" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">办理预付卡先行赎回资金结转金额（减）L07<span>*</span></td>
												<td width="200"><input type="text" id="L07" name="L07" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">本期实现的手续费收入（加）L08<span>*</span></td>
												<td width="200"><input type="text" id="L08" name="L08" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">已增加客户资金未增加备付金（减）L09<span>*</span></td>
												<td width="200"><input type="text" id="L09" name="L09" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">已减少客户资金未减少备付金（加）L10<span>*</span></td>
												<td width="200"><input type="text" id="L10" name="L10" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">已增加备付金未增加客户资金（加）L11<span>*</span></td>
												<td width="200"><input type="text" id="L11" name="L11" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">已减少备付金未减少客户资金（减）L12<span>*</span></td>
												<td width="200"><input type="text" id="L12" name="L12" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">本期收到利息收入（加）L13<span>*</span></td>
												<td width="200"><input type="text" id="L13" name="L13" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">本期申请存放的自有资金（加）L14<span>*</span></td>
												<td width="200"><input type="text" id="L14" name="L14" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">银行扣取的手续费、管理费（减）L15<span>*</span></td>
												<td width="200"><input type="text" id="L15" name="L15" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">结转的风险准备金（减）L16<span>*</span></td>
												<td width="200"><input type="text" id="L16" name="L16" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">本期结转利息收入（减）L17<span>*</span></td>
												<td width="200"><input type="text" id="L17" name="L17" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">本期结转手续费收入（减）L18<span>*</span></td>
												<td width="200"><input type="text" id="L18" name="L18" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">本期提出原申请存放的自有资金（减）L19<span>*</span></td>
												<td width="200"><input type="text" id="L19" name="L19" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">其他调整项目L20<span>*</span></td>
												<td width="200"><input type="text" id="L20" name="L20" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">试算值L21<span>*</span></td>
												<td width="200"><input type="text" id="L21" name="L21" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">备付金银行账户余额期初值L22<span>*</span></td>
												<td width="200"><input type="text" id="L22" name="L22" value="" class="form-control" style="color:#d9534f" onblur="getL24();"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">备付金银行账户余额期末值L23<span>*</span></td>
												<td width="200"><input type="text" id="L23" name="L23" value="" class="form-control" style="color:#d9534f" onblur="getL24();"></td>
												<td width="150"></td>
												<td width="250" class="text-right">备付金银行账户余额净增加（减少）L24<span>*</span></td>
												<td width="200"><input type="text" id="L24" name="L24" value="" class="form-control" style="color:#d9534f" disabled="disabled"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">预付卡押金业务调整金额（减）Z01<span>*</span></td>
												<td width="200"><input type="text" id="Z01" name="Z01" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">在备付金银行存放的预付卡押金本期净增加数CU<span>*</span></td>
												<td width="200"><input type="text" id="CU" name="CU" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="15"></tr>
											<tr>
												<td width="250" class="text-right">本期新增应收但未收到的预付卡押金金额CV<span>*</span></td>
												<td width="200"><input type="text" id="CV" name="CV" value="" class="form-control" style="color:#d9534f"></td>
												<td width="150"></td>
												<td width="250" class="text-right">其它OR1<span>*</span></td>
												<td width="200"><input type="text" id="OR1" name="OR1" value="" class="form-control" style="color:#d9534f"></td>
											</tr>
											<tr height="10"></tr>
										</table>
										<div class="row">
