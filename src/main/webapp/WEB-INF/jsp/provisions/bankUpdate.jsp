...
<script type="text/javascript">	
	...
	function updateBank() {
		...
		$.post("<%=request.getContextPath()%>/provisions/bankModify.do",{
					bankCode:bankCode,
											...
											<div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-12 col-xs-12">
												<table width="100%" class="product_detail_list">
													<tr>
														...
														<td width="200">
															<input type="text" id="bankName" name="bankName" value="${bank.bankName}" class="form-control"></td>
														<td></td>
													</tr>
												</table>
											</div>
											...
											<div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-12 col-xs-12">
												...
												<table width="100%" class="product_detail_list">
													<tr>
														...
														<td width="200">
															<input type="text" id="bankCode" name="bankCode" value="${bank.bankCode}" class="form-control" style="color:#d9534f" disabled="disabled"></td>
														<td></td>
													</tr>
												</table>
											</div>
													...
													<tr>
														...
														<td width="200">
															<select class="form-control" id="bankType" name="bankType" tabindex="10">
																<option <c:if test="${bank.bankType==''}">selected="selected"</c:if> value="">--请选择--</option>
																<option <c:if test="${bank.bankType=='1'}">selected="selected"</c:if> value="1">存管银行</option>
																<option <c:if test="${bank.bankType=='2'}">selected="selected"</c:if> value="2">合作银行</option>
															</select>
														</td>
														<td></td>
													</tr>
													...
													<tr>
														...
														<td width="200">
															<select class="form-control" id="sendType" name="sendType" tabindex="10">
																<option <c:if test="${bank.sendType==''}">selected="selected"</c:if> value="">--请选择--</option>
																<option <c:if test="${bank.sendType=='1'}">selected="selected"</c:if> value="1">直连</option>
																<option <c:if test="${bank.sendType=='2'}">selected="selected"</c:if> value="2">手工</option>
															</select>
														</td>
														<td></td>
													</tr>
											...
											<div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-12 col-xs-12">
												...
												<table width="100%" class="product_detail_list">
													<tr>
														...
														<td width="200">
															<input type="text" id="merchantId" name="merchantId" value="${bank.merchantId}" class="form-control" ></td>
														</td>
														<td></td>
													</tr>
												</table>
											...
											<div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-12 col-xs-12">
												...
												<table width="100%" class="product_detail_list" >
													<tr>
														...
														<td width="200">
															<input type="text" id="merchantName" name="merchantName" value="${bank.merchantName}" class="form-control"></td>
														</td>
														<td></td>
													</tr>
												</table>
													...
													<tr>
														...
														<td width="200" >
															<c:forEach items="${ allFormMap}" var="all">
																<input type="checkbox" id="report" name="report" value="${all.key}" class="form-control" 
												...
												<table width="100%" class="product_detail_list">
													<tr>
														...
														<td>
															...
															<input type="button" value="修改" id="btn" onclick="updateBank()" class="btn btn-primary margin30" /> 
