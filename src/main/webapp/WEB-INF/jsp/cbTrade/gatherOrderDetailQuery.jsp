			...
			<div id="page-wrapper">
				...
				<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
					<ol class="breadcrumb page-breadcrumb">
						...
						<li>收款管理&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;
						</li>
						<li>收款订单查询&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;
						</li>
					</ol>
				...
				<!--这是查询模块开始-->
					<div class="panel panel-default" style="display: none;">
						...
						<div class="panel-body">
							<form id="queryForm"
								action="<%=request.getContextPath()%>/cbTrade/forex/gather/querydetail"
									...
									<tbody>
										<c:forEach items="${page.list}" var="order">
											<tr>
												...
												<td><fmt:formatDate pattern="YYYY-MM-DD" value="${order.shipDate }"/></td>
												<td><fmt:formatDate pattern="YYYY-MM-DD" value="${order.receivedDate }"/></td>
